...
public class CinemaAvaliacao {
    ...
    public CinemaAvaliacao(Cinema cinema, User usuario, Integer notaGeral, Integer notaLimpeza,
                           Integer notaAtendimento, Integer notaPreco, Integer notaAlimentacao,
                           String comentario) {
        this.cinema = cinema;
        this.usuario = usuario;
        this.notaGeral = notaGeral;
